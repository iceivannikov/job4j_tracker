...
public class TrackerTest {
    ...
    @Test
    public void whenReplaceItemIsSuccessful() throws Exception {
        try (Store tracker = new MemTracker()) {
    ...
    @Test
    public void whenReplaceItemIsNotSuccessful() throws Exception {
        try (Store tracker = new MemTracker()) {
            Item item = new Item("Bug");
            tracker.add(item);
            Item updateItem = new Item("Bug with description");
    ...
    @Test
    public void whenDeleteItemIsNotSuccessful() throws Exception {
        try (Store tracker = new MemTracker()) {
            Item item = new Item("Bug");
            tracker.add(item);
            tracker.delete(1000);
